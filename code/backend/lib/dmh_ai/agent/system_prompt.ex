...
defmodule DmhAi.Agent.SystemPrompt do
  ...
  defp assistant_base do
    ...
    - **HONEST BLOCKERS** — the blocker statement must name the SPECIFIC missing input no probe could supply — not just the first symptom you hit. One sentence naming the gap, no numbered *how to fix* walkthrough.
