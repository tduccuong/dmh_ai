        ...
        en: {
            ...
            splashConfidant: {
                ...
                bullets: [
                    ...
                    { strong: '/tts &lt;text&gt;', text: 'Read text out loud in your language of choice — or a previous answer of mine if no text is given.' },
        ...
        vi: {
            ...
            splashConfidant: {
                ...
                bullets: [
                    ...
                    { strong: '/tts &lt;nội dung&gt;', text: 'Đọc to văn bản bằng ngôn ngữ bạn chọn — hoặc câu trả lời trước của tôi nếu không nhập nội dung.' },
        ...
        de: {
            ...
            splashConfidant: {
                ...
                bullets: [
                    ...
                    { strong: '/tts &lt;Text&gt;', text: 'Text in deiner Wunschsprache vorlesen — oder eine vorherige Antwort von mir, wenn kein Text angegeben ist.' },
        ...
        es: {
            ...
            splashConfidant: {
                ...
                bullets: [
                    ...
                    { strong: '/tts &lt;texto&gt;', text: 'Lee el texto en voz alta en el idioma que elijas — o una respuesta mía anterior si no das texto.' },
        ...
        fr: {
            ...
            splashConfidant: {
                ...
                bullets: [
                    ...
                    { strong: '/tts &lt;texte&gt;', text: 'Lis le texte à voix haute dans la langue de ton choix — ou une réponse précédente de moi si aucun texte n’est donné.' },
