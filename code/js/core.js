...
const I18n = {
    ...
    _strings: {
        en: {
            ...
            splashConfidant: {
                title: "Hi, I'm DMH-AI Confidant.",
                lead: 'Your companion for quick, insightful chats and instant answers.',
                bullets: [
                    { strong: 'Type: /memo &lt;text&gt;', text: 'Encrypt & save private notes. Ready for future lookups via keywords.' },
                    { strong: 'Multimedia', text: 'Upload photos, videos, or documents to ask questions about them.' },
                    { strong: 'Fast & Direct', text: 'Optimized for speed, presence, and direct companionship.' },
                ],
            ...
            splashAssistant: {
                ...
                bullets: [
                    { strong: 'Type: /memo &lt;text&gt;', text: 'Encrypt & save private notes. Ready for future lookups via keywords.' },
                    { strong: 'Type: /wiki &lt;source&gt;', text: 'Index a URL, file path, or text into your knowledge base.' },
        ...
        vi: {
            ...
            splashConfidant: {
                title: 'Chào bạn, tôi là DMH-AI Bạn thân.',
                lead: 'Người đồng hành trò chuyện, sâu sắc và phản hồi nhanh.',
                bullets: [
                    ...
                    { strong: 'Nhanh & Trực tiếp', text: 'Tối ưu cho tốc độ và sự gần gũi.' },
                ],
            ...
            splashAssistant: {
                ...
                bullets: [
                    { strong: 'Gõ: /memo &lt;nội dung&gt;', text: 'Lưu & mã hóa ghi chú riêng tư. Truy vấn trong tương lai theo từ khóa.' },
                    { strong: 'Gõ: /wiki &lt;nguồn&gt;', text: 'Lưu danh mục URL, tệp tài liệu hoặc văn bản vào cơ sở tri thức.' },
        ...
        de: {
            ...
            splashConfidant: {
                title: 'Hi, ich bin DMH-AI Vertrauter.',
                lead: 'Dein Begleiter für schnelle, tiefgründige Chats und sofortige Antworten.',
                bullets: [
                    ...
                    { strong: 'Schnell & Direkt', text: 'Optimiert für Geschwindigkeit und echte Interaktion.' },
                ],
            ...
            splashAssistant: {
                ...
                bullets: [
                    { strong: 'Tippe: /memo &lt;Text&gt;', text: 'Verschlüsseln & private Notizen speichern. Bereit für zukünftige Abfragen über Schlüsselwörter.' },
                    { strong: 'Tippe: /wiki &lt;Quelle&gt;', text: 'URL, Datei oder Text in deine Wissensdatenbank aufnehmen.' },
        ...
        es: {
            ...
            splashConfidant: {
                title: 'Hola, soy DMH-AI Confidente.',
                lead: 'Tu compañero para charlas rápidas, profundas y respuestas al instante.',
                bullets: [
                    ...
                    { strong: 'Rápido y Directo', text: 'Optimizado para velocidad y cercanía real.' },
                ],
            ...
            splashAssistant: {
                ...
                bullets: [
                    { strong: 'Escribe: /memo &lt;texto&gt;', text: 'Cifra y guarda notas privadas. Listo para futuras búsquedas por palabras clave.' },
                    { strong: 'Escribe: /wiki &lt;fuente&gt;', text: 'Indexa URL, archivos o texto en tu base de conocimientos.' },
        ...
        fr: {
            ...
            splashConfidant: {
                title: 'Salut, je suis DMH-AI Confident.',
                lead: 'Ton compagnon pour des échanges rapides et des réponses instantanées.',
                bullets: [
                    ...
                    { strong: 'Rapide & Direct', text: 'Optimisé pour la vitesse et une présence authentique.' },
                ],
            ...
            splashAssistant: {
                ...
                bullets: [
                    { strong: 'Tapez: /memo &lt;texte&gt;', text: 'Chiffrez et enregistrez des notes privées. Prêt pour de futures recherches par mots-clés.' },
                    { strong: 'Tapez: /wiki &lt;source&gt;', text: 'Indexe une URL, un fichier ou du texte dans ta base.' },
